...
Elm.Binary.make = function (_elm) {
   ...
   var _op = {};
   var eraseWall = F3(function (x,y,maze) {
      var isRoom = function (room) {    return _U.eq(room.x,x) && _U.eq(room.y,y);};
      var newRoom = function (room) {    var _p0 = isRoom(room);if (_p0 === true) {    return _U.update(room,{northWall: false});} else {    return room;}};
      return A2($List.map,newRoom,maze);
   });
   ...
   var main = view(A3(eraseWall,0,0,maze));
